 ...
 */
@WebServlet("/sellerindentQuerya")
public class sellerindentQuerya extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public sellerindentQuerya() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		String mySql = "select price*number as sumprice,indentId,bookname,price,number,status,indent.userid,username,dilivery,pay,indent.address,indent.tel from indent,booklist,shopuser where indent.userid=shopuser.userid and indent.status='已完成' and indent.bookid=booklist.bookid and booklist.userid='"+id+"'";
		...
		try {
			...
			System.out.println("adjfhakjdh:"+e.getMessage());
		}
	}
