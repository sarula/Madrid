 ...
 */
@WebServlet("/IndentQuery")
public class IndentQuery extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		String mySql = "select price*number as sumprice,indentId,bookname,price,number,status,dilivery,pay from indent,booklist where indent.status='待收货' and indent.bookid=booklist.bookid and indent.userid='"
				+ id + "'";
